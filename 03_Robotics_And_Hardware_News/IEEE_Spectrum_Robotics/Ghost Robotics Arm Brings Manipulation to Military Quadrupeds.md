...
## 요약
![](https://spectrum.ieee.org/media-library/robotic-dog-lifting-backpack-with-its-mechanical-arm-in-an-industrial-setting.jpg?id=62304619&width=1245&height=700&coordinates=0%2C187%2C0%2C188)  
...
In that context, it’s not unreasonable to assume that Ghost’s robots may sometimes be used to carry weapons, and despite the [proliferation of robots](https://spectrum.ieee.org/ukraine-killer-drones) in many roles in the Ukraine war, the idea of a legged robot carrying a weapon is not a comfortable one for many people. **IEEE Spectrum** spoke with Ghost co-founder and current CEO [Gavin Kenneally](https://www.linkedin.com/in/gavin-kenneally-321a3833/) to learn more about the new arm, and to get his perspective on selling robots to the military.

![Green military robot dog opens a wooden door with articulated arm.](https://spectrum.ieee.org/media-library/green-military-robot-dog-opens-a-wooden-door-with-articulated-arm.jpg?id=62304622&width=980) The Vision 60’s new arm has six degrees of freedom. Ghost Robotics

Robots for the Military
-----------------------

Ghost Robotics initially made a name for itself with its very impressive [early work with the Minitaur direct-drive quadruped](https://spectrum.ieee.org/ghost-robotics-minitaur-quadruped) in 2016. The company also made headlines in late 2021, when a now-deleted post on Twitter (now X) went viral because it included a photograph of one of Ghost’s Vision 60 quadrupeds [with a rifle mounted on its back](https://spectrum.ieee.org/ghost-robotics-armed-military-robots).

That picture resulted in a [very strong reaction](https://kodlab.seas.upenn.edu/news/koditscheks-letter-to-ghosts-ceo/), although as **IEEE Spectrum** reported at the time, robots with guns affixed to them wasn’t new: To mention one early example, the U.S. military had already deployed weapons on mobile robots [in Iraq in 2007](https://www.wired.com/2008/04/armed-robots-st/). And while several legged robot companies [pledged in 2022 not to weaponize their general purpose robots](https://spectrum.ieee.org/robots-with-weapons-industry-initiative), the Chinese military [in 2024 displayed](https://www.theguardian.com/science/article/2024/may/30/chinese-armys-latest-weapon-gun-toting-dog) quadrupeds from Unitree equipped with guns. (Unitree, based in China, was one of the signers of the 2022 pledge.)

The issue of weaponized robots goes far beyond Ghost Robotics, and far beyond robots with legs. We’ve covered both the [practical](https://spectrum.ieee.org/we-should-not-ban-killer-robots) and [ethical](https://spectrum.ieee.org/a-path-towards-reasonable-autonomous-weapons-regulation) perspectives on this extensively at **IEEE Spectrum**, and the intensity of the debates show that there is no easy answer. But to summarize one important point made by some ethicists, some military experts, and Ghost Robotics itself: robots are replaceable, humans are not. “Customers use our robots to keep people out of harm’s way,” Ghost CEO Kenneally tells **Spectrum.**

It’s also worth pointing out that even the companies who signed the pledge not to weaponize their general purpose robots [acknowledge](https://spectrum.ieee.org/robots-with-weapons-industry-initiative) that military robots exist, and are accepting of that, provided that such robots are used under existing legal doctrines and operate within those safeguards—and that what constraints should or should not be imposed on these kinds of robots is best decided by policymakers rather than industry.
...
![Robotic dog opening a glass door with its arm in front of a building.](https://spectrum.ieee.org/media-library/robotic-dog-opening-a-glass-door-with-its-arm-in-front-of-a-building.jpg?id=62304623&width=980) The Vision 60 can open doors withe high-level direction from a human operator.Ghost Robotics
...
The United States is poised to [ban consumer drone sales from Chinese manufacturer DJI](https://www.reuters.com/world/us/chinese-dronemaker-dji-urges-us-complete-security-review-2025-12-04/), and [banned DJI drone use by federal agencies in 2017](https://www.defenseone.com/technology/2017/08/us-army-just-ordered-soldiers-stop-using-drones-chinas-dji/139999/). But it may be too late in some sense, as DJI’s global market share is [something like 90 percent](https://www.technologyreview.com/2024/06/26/1094249/china-commercial-drone-dji-security/). Meanwhile, Unitree may have already cornered [somewhere around 70 percent](https://newsletter.semianalysis.com/p/quadruped-state-of-the-market-unitree) of the global market for quadrupeds, despite [the recent publication of exploits](https://spectrum.ieee.org/unitree-robot-exploit) that allow the robots to send unauthorized data to China.
