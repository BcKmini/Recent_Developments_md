...
## 요약
![](https://spectrum.ieee.org/media-library/a-person-stands-on-a-boat-in-front-of-a-large-mechanical-apparatus-bearing-noaa-logo.png?id=62218869&width=1200&height=600&coordinates=0%2C521%2C0%2C522)  
...
That call came from [Harlan Kredit](https://nthf.org/inductees/harlan-kredit/), a nationally renowned science teacher and board member of a Rhode Island-based nonprofit called the [Global Foundation for Ocean Exploration](https://www.engineeringfordiscovery.org/) (GFOE). The organization was looking for an electrical engineer to help design, build, and pilot remotely operated vehicles (ROVs) for the U.S. [National Oceanic and Atmospheric Administration](https://www.noaa.gov/).
...
The GFOE’s contract with NOAA expired in July, forcing the engineering team to disband. But soon after, Unema teamed up with four former colleagues to start their own ROV consultancy, called [Deep Exploration Solutions](https://deepexplorationsolutions.com/), to continue the work he’s so passionate about.
...
Kredit has won numerous awards for his work as an educator, including the Presidential Award for Excellence in Science Teaching in 2004. Like Unema, he also shares a love for the outdoors as Yellowstone National Park’s [longest-serving park ranger](https://www.lyndentribune.com/news/50-years-at-yellowstone-harlan-kredit-is-suspected-longest-serving-ranger-in-park-s-history/article_0311911c-18b4-11ed-95b6-97025762a862.html). “He was an excellent science teacher, very inspiring,” says Unema.

When Unema graduated high school in 2010, he decided to enroll at his father’s alma mater, [Michigan Technological University](https://www.mtu.edu/), to study engineering. He was initially unsure what discipline to follow and signed up for the general engineering course, but he quickly settled on electrical engineering.

A summer internship at a steel mill run by the multinational corporation [ArcelorMittal](https://corporate.arcelormittal.com/) introduced Unema to factory automation and assembly lines. After graduating in 2014 he took a job at [Gentex Corp.](https://www.gentex.com/) in Zeeland, Mich., where he worked on manufacturing systems and industrial robotics.
...
![Technicians operate complex control panels with multiple monitors in a dark, focused environment.](https://spectrum.ieee.org/media-library/technicians-operate-complex-control-panels-with-multiple-monitors-in-a-dark-focused-environment.png?id=62218876&width=980) Unema conducts predive checks from the Okeanos Explorer’s control room. Once the ROV is launched, scientists will watch the camera feeds and advise his team where to direct the vehicle.[Art Howard](https://www.art-work.global/high-seas)
...
[Communications](https://spectrum.ieee.org/underwater-communication) are another challenge. The ROVs rely on several kilometers of cable containing just three single-mode optical fibers. “All the communication needs to come together and then go up one cable,” Unema says. “And every year new instruments consume more data.”

He works exclusively on ROVs that are custom made for scientific research, which require smoother control and considerably more electronics and instrumentation than the heavier-duty vehicles used by the [oil and gas](https://spectrum.ieee.org/the-gulf-spills-lessons-for-robotics) industry. “The science ones are all hand-built, they’re all quirky,” he says.

Unema’s role spans the full life cycle of an ROV’s design, construction, and operation. He primarily spends winters upgrading and maintaining vehicles and summers piloting them on expeditions. At GFOE, he mainly worked on two ROVs for NOAA called **Deep Discoverer** and **Seirios**, which operate from the ship **Okeanos Explorer**. But he has also piloted ROVs for other organizations over the years, including the [Schmidt Ocean Institute](https://schmidtocean.org/) and the [Ocean Exploration Trust](https://nautiluslive.org/).
...
Unema also relishes the challenge of solving engineering problems with the [limited resources available](https://spectrum.ieee.org/apollo-13-we-have-a-solution) on the ship. “We’re going out to the middle of the Pacific,” he says. “Things break, and you’ve got to fix them with what you have out there.”
