...
**출처:** [IEEE_Spectrum_Robotics](https://spectrum.ieee.org/holiday-robot-videos)

## 요약
![](https://spectrum.ieee.org/media-library/robots-near-christmas-tree-with-tv-snowman-and-leg-lamp-in-festive-room.png?id=62631880&width=1200&height=800&coordinates=156%2C0%2C156%2C0)  
...
[ [ETH Zurich Robotics System Lab](https://rsl.ethz.ch/) ]

[Happy Holidays](https://spectrum.ieee.org/happy-holidays-robot) from FieldAI!

[ [FieldAI](https://www.fieldai.com/) ]

Happy Holidays from the Institute of Robotics and Machine Intelligence at [Poznan University of Technology](https://spectrum.ieee.org/video-friday-iros-2014)!

[ [Poznan University of Technology IRMI](https://creef.put.poznan.pl/en/research-infrastructure/irim) ]

Happy Holidays from BruBotics!

[ [AugmentX](https://augmentx.be/) ]
...
> *Big news: [Badminton](https://spectrum.ieee.org/video-friday-robots-table-tennis) just got a new training partner. Our humanoid robot can rally with a human in continuous exchanges, combining fast returns with stable movement. Peak return speed reaches 19.1 m/s.*

[ [Phybot](https://www.phybot.tech/en) ]
...
[ [Paper](https://advanced.onlinelibrary.wiley.com/doi/10.1002/aisy.202401055) ]
...
[ [AirLab](https://superodometry.com/) ]
