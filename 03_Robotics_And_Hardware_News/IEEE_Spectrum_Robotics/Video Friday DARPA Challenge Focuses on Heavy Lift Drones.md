...
## 요약
![](https://spectrum.ieee.org/media-library/barbell-weight-plates-flying-over-a-checkered-finish-line-in-a-sunny-field-with-flags.png?id=62177472&width=2000&height=1500&coordinates=480%2C0%2C480%2C0)  
...
There is absolutely no reason to give [robots hands](https://spectrum.ieee.org/3d-printed-robot-hand) if you can just teach them to lasso stuff instead.

[ [ArcLab](https://arclab.hku.hk/) ]
...
[ [DRAGON Lab](https://advanced.onlinelibrary.wiley.com/doi/10.1002/aisy.202500640) ]

Thanks, Moju!

I am pretty sure that you should not use a [quadrupedal robot](https://spectrum.ieee.org/quadrupedal-robot) to transport your child. But only pretty sure, not totally certain.
...
[ [BFM-Zero](https://lecar-lab.github.io/BFM-Zero/) ]

Welcome to the very, very near future of manual labor.

[ [AgileX](https://global.agilex.ai/products/cobot-magic) ]
...
[ [Paper](https://ieeexplore.ieee.org/document/11224394/) ] via [ [KIMLAB](https://publish.illinois.edu/kimlab2020/) ]
...
How mobile of a [mobile manipulator](https://spectrum.ieee.org/mobile-manipulation-robots-having-fun) do you need?

[ [Clearpath Robotics](https://clearpathrobotics.com/warthog-unmanned-ground-vehicle-robot/) ]
