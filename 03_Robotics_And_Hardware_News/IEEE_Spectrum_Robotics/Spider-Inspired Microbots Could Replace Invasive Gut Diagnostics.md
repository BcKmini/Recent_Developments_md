...
## 요약
![](https://spectrum.ieee.org/media-library/conceptual-illustration-of-a-mini-cross-shaped-soft-robot-tumbling-down-the-length-of-a-small-intestine.jpg?id=62003291&width=1200&height=800&coordinates=120%2C0%2C120%2C0)  
...
A team led by [Qingsong Xu](https://www.fst.um.edu.mo/people/qsxu/), a professor of electromechanical engineering at the University of Macau in China, recently [unveiled a micro-robot prototype](https://www.eurekalert.org/news-releases/1102526) inspired by the locomotion of an African spider that cartwheels across the desert dunes of Namibia instead of crawling.
...
[Other teams](https://spectrum.ieee.org/swallowable-robotic-pill-gut-health) have experimented with various types of robot locomotion, including crawling, jumping, and swimming, the researchers [said in a paper](https://iopscience.iop.org/article/10.1088/2631-7990/ae0214) describing the new robot, published in the *International Journal of Extreme Manufacturing* last month. Those earlier designs, however, had limitations when traversing such complex environments as the digestive tract.

![Timelapse of a miniature cross-shaped soft robot navigating wrinkled terrain inside a stomach.](https://spectrum.ieee.org/media-library/timelapse-of-a-miniature-cross-shaped-soft-robot-navigating-wrinkled-terrain-inside-a-stomach.jpg?id=62003332&width=980) These series of images show how the robot moves through the stomach. In the rightmost column, the researchers also demonstrate targeted drug delivery. [Ruomeng Xu, Xianli Wang, et al.](https://iopscience.iop.org/article/10.1088/2631-7990/ae0214)
...
In the not-so-distant future, advances in micro-robotics may enable targeted [drug delivery](https://spectrum.ieee.org/tag/drug-delivery) in the treatment of ulcers or tumors. The tiny robots could also be used in a range of minimally invasive interventions and examinations. The field has been growing rapidly in the past few years, although no such robots have yet made it into clinical practice, and magnetically controlled robots are a promising field of development many researchers are exploring.

For example, a team from [North Carolina State University](https://www.eurekalert.org/news-releases/1102619) recently presented another such robot, also using a flexible magnetic material. Instead of cartwheeling, the North Carolina robot crawls through the digestive tract like a caterpillar; the external magnetic forces induce contractions in its 3D-printed origami-style structure. A paper published in the journal [*Advanced Functional Materials*](https://advanced.onlinelibrary.wiley.com/doi/10.1002/adfm.202516404?af=R) described experiments with the robot delivering mock treatment to a mock stomach ulcer.

[Xiaomeng Fang](https://textiles.ncsu.edu/people/xfang3/), assistant professor in material engineering at North Carolina State University and lead author of the paper, told *IEEE Spectrum* the work has garnered a lot of interest. “These robots are soft and they can be controlled remotely,” she said. “They can also change their shape, which makes them very interesting for treatment of internal diseases.”
