...
**출처:** [IEEE_Spectrum_Robotics](https://spectrum.ieee.org/video-friday-baseball-robot)

## 요약
![](https://spectrum.ieee.org/media-library/robotic-arm-with-glove-attached-surrounded-by-complex-machinery-and-cables-catching-a-baseball.png?id=62221544&width=1200&height=800&coordinates=150%2C0%2C150%2C0)  
...
##### [SOSV Robotics Matchup](https://sosv.com/announcing-sosvs-vc-founder-robotics-matchup-dec-1-5/): 1–5 December 2025, ONLINE
...
[ [Stanford BDML](https://bdml.stanford.edu/) ]
...
[ [DARPA](https://www.darpa.mil/news/2025/dart-msai-triumph-darpa-triage-challenge) ]
...
[ [Moritz Baecher](https://www.linkedin.com/posts/baecher_robot-crash-course-using-reinforcement-learning-activity-7395125099823091712-aeUt/) ]

Oh look, more [humanoid](https://spectrum.ieee.org/topic/robotics/humanoid-robots/) acrobatics.
...
[ [MagicLab](https://www.magiclab.top/en/z1) ]
...
[ [TUM](https://www.tum.de/en/news-and-events/all-news/press-releases/details/nesting-facade-from-the-3d-printer-serves-humans-and-animals) ]

All those [UBTECH](https://www.ubtrobot.com/) Walker S2 robots weren’t fake, it turns out.

[ [UBTECH](https://www.ubtrobot.com/en/humanoid/products/walker-s2) ]
...
[ [Motoman](https://www.motoman.com/en-us) ]
...
[ [Cobot](https://www.co.bot/) ]

> *Humanoid robots have long captured our imagination. Interest has skyrocketed along with the perception that robots are getting closer to taking on a wide range of labor-intensive tasks. In this discussion, we reflect on what we’ve learned by observing factory floors, and why we’ve grown convinced that chasing generalization in manipulation—both in hardware and behavior—isn’t just interesting, but necessary. We’ll discuss AI research threads we’re exploring at [Boston Dynamics](https://bostondynamics.com/) to push this mission forward, and highlight opportunities our field should collectively invest more in to turn the humanoid vision, and the reinvention of manufacturing, into a practical, economically viable product.*

[ [Boston Dynamics](https://bostondynamics.com/webinars/why-humanoids-are-the-future-of-manufacturing/) ]
...
[ [Michigan Robotics](https://robotics.umich.edu/events/robotics-seminar-series/) ]

Ask the [OSRF](https://spectrum.ieee.org/tag/osrf) Board of Directors anything! Or really, listen to other people ask them anything.
